<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddTrainer.aspx.cs" Inherits="Gym_Online_2.Views.Admin.AddTrainer" %>
        ...
        <section class="wrapper site-min-height">
            <div class="container">
                ...
                <div class="card-details">                   
                    <div class="card-box">
                        <span class="details">TrainerName</span>
                          <asp:TextBox ID="txttrinername" runat="server" CssClass="txt" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                    <div class="card-box">
                        <span class="details">Gender</span>                         
                           <asp:RadioButton ID="rdbmale" runat="server" Text="Male" GroupName="Role" CssClass="rdb"/>        
                           <asp:RadioButton ID="rdbfemale" runat="server" Text="FeMale" GroupName="Role"/>                    
                    </div>
                    <div class="card-box">
                    ...
                    <div class="card-box">
                        ...
                        <asp:TextBox ID="txtphone" runat="server" CssClass="txt" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                    <div class="card-box">
                    ...
                    <div class="card-box">
                        ...
                        <asp:TextBox ID="txttrineetyepe" runat="server" CssClass="txt" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                </div>
                <div class="button">
